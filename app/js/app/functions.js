...
(function() {
  ...
  app.synchGetCreatureNameByGuid = function(guid) {
    ...
    request.open(
      "GET",
      app.api + "creature/creature_addon/guid/" + guid,
      false
    );
    request.send(null);
  ...
  app.synchGetQuestTitleByCriteriaFunc1 = function(
    requiredNpcOrGo1,
    requiredNpcOrGo2,
    requiredNpcOrGo3,
    requiredNpcOrGo4
  ) {
    if (requiredNpcOrGo1 == undefined) {
      requiredNpcOrGo1 = "";
    }
    if (requiredNpcOrGo2 == undefined) {
      requiredNpcOrGo2 = "";
    }
    if (requiredNpcOrGo3 == undefined) {
      requiredNpcOrGo3 = "";
    }
    if (requiredNpcOrGo4 == undefined) {
      requiredNpcOrGo4 = "";
    }
    var request, data;
    request = new XMLHttpRequest();
    request.open(
      "GET",
      app.api +
        "custom/GetQuestTitleByCriteria/?" +
        "RequiredNpcOrGo1=" +
        requiredNpcOrGo1 +
        "&" +
        "RequiredNpcOrGo1=" +
  ...
  app.synchGetQuestTitleByCriteriaFunc2 = function(
    requiredNpcOrGo1,
    requiredNpcOrGo2,
    requiredNpcOrGo3,
    requiredNpcOrGo4,
  ...
  app.synchGetGameObjectNameById = function(id) {
    ...
    request.open(
      "GET",
      app.api + "gameobject/gameobject_template/" + id,
      false
    );
    request.send(null);
